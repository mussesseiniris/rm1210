  ...
  const albums = [
    {
      ...
      imgs: [
        {
          src: "/images/images/zhushan_design.png",
          desc: "Design Concept",
        },
        { src: "/images/images/zhushanLake.png", desc: "Master plan" },
        {
          src: "/images/images/zhushan_Currentphotoes.png",
          desc: "Site photos before renovation",
        },
        { src: "/images/images/zhushan_rendering1.png", desc: "Rendering" },
        { src: "/images/images/zhushan_birdview.png", desc: "Bird's-eye view" },
      ],
    },
    {
      ...
      imgs: [
        {
          src: "/images/images/bj07.png",
          desc: "Master Plan",
        },
        { src: "/images/images/bj01.png", desc: "Background Research" },
        { src: "/images/images/bj02.png", desc: "Design Strategy" },
        { src: "/images/images/bj03.png", desc: "Design Strategy" },
        { src: "/images/images/bj05.png", desc: "Design Scheme" },
        { src: "/images/images/bj06.png", desc: "Design Scheme" },
        { src: "/images/images/bj00.png", desc: "Background Research" },
        { src: "/images/images/bj08.png", desc: "Elevation" },
      ],
    },
    {
      ...
      imgs: [
        {
          src: "/images/images/js1.png",
          desc: "Background Research",
        },
        { src: "/images/images/js_concept.png", desc: "Design Concept" },
        { src: "/images/images/jscp.png", desc: "Master Plan" },
        { src: "/images/images/jsjt.png", desc: "Route Organisation Analysis Diagram" },
        { src: "/images/images/jsxgt.png", desc: "Rendering" },
      ],
    },
    {
      title:
      ...
      year: "2023",
      imgs: [
        { src: "/images/images/hm1.png", desc: "Master Plan" },
        { src: "/images/images/hm2.png", desc: "Detailed Construction Drawings" },
        { src: "/images/images/hm3.png", desc: "Plant Design Table" },
      ],
    },
    {
      ...
      imgs: [
        {
          src: "/images/images/photoBirdnz01.jpg",
          desc: "",
        },
        {
          src: "/images/images/photoBird01.jpg",
          desc: "Pterorhinus sannio | White-browed Laughingthrush",
        },
        {
          src: "/images/images/photoBird02.jpg",
          desc: "Eophona migratoria | Chinese Grosbeak",
        },
        {
          src: "/images/images/photoBird03.jpg",
          desc: "Egret",
        },
        {
          src: "/images/images/photoBirdnz02.jpg",
          desc: "California quail | Tikaokao",
        },
        {
          src: "/images/images/photoBird05.jpg",
          desc: "Prosthemadera novaeseelandiae | Tūī",
        },
         {
          src: "/images/images/photoBirds.jpg",
          desc: "migratory birds",
        },
              {
          src: "/images/images/photoBirds2.jpg",
          desc: "migratory birds",
        },
              {
          src: "/images/images/photographyMoon.jpg",
          desc: "Moon",
        },
               {
          src: "/images/images/photoMoon.jpg",
          desc: "Eclipse",
        },
                 {
          src: "/images/images/photoSunset.jpg",
          desc: "Sunset",
        }
      ],
    },
    {
      ...
      imgs: [
        {
          src: "/images/images/pink.jpg",
          desc: "Garden",
        },
        {
          src: "/images/images/painting_procreatblack.jpg",
          desc: "Swirl",
        },
          {
          src: "/images/images/girl.png",
          desc: "The Night Is Short, Walk On Girl",
        },
        {
          src: "/images/images/painting_procreatCat.jpg",
          desc: "Cat",
        },
        {
          src: "/images/images/painting_procreatPeople.jpg",
          desc: "Girl",
        },
        {
          src: "/images/images/watercolorMatisse.jpg",
          desc: "Matisse",
        },
        {
          src: "/images/images/paintingSolaris.jpg",
          desc: "Solaris",
        },
        {
          src: "/images/images/watercolor.jpg",
          desc: "Centaurea cyanus | Cornflower",
        },
        {
          src: "/images/images/watercolor02.jpg",
          desc: "Spirited Away",
        },
          {
          src: "/images/images/snoopy.png",
          desc: "Snoopy",
        },
      ],
    },
